...
class App {
        ...
        when (tipusFigura){
            ...
            "cercle" -> {
                try {
                    ...
                    var nouCercle = Circulo(x, y, r, this.getColor(color))
                    // I l'afegim a la llista
            ...
            "elipse" -> {
                try {
                    ...
                    // Si tot és correcte creem la figura elipse
                    var nouElipse = Elipse(x, y, r1, r2, this.getColor(color))
                    // I l'afegim a la llista
                    escena.add(nouElipse)
                } catch (err: Exception) {
                    println("\u001B[31m Arguments incorrectes \u001B[0m");
                }
            }
    ...
    fun startCli(){
        do {
            ...
            when (figura) {
                in arrayOf("rectangle", "cercle", "linia", "quadrat", "elipse") ->{
